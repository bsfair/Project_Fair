...
export default class NFRL_Customer_AdminViewScreen extends React.Component {
  ...
  ShowNFRLCustomer = async () => {
    ...
    fetch(
      'http://172.17.146.223/traineedrive/public/api/nfrl2/customer/' + this.state.id
    )
  ...
  DeleteData = async () => {
    ...
    navigate('NFRL_Customer_AdminList');
  }
    ...
    <ImageBackground source={require('../../image/detailBackgroundImage.jpg')}
      ...
      <NavigationEvents
        ...
        <View style={styles.buttonSection}>
            <Button
              onPress={ () => {
                navigate('NFRL_Customer_AdminEdit',{   
